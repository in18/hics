...
echo. >> %log_pfad%
echo.
@call :einarbeiten1 "Dropping Database" 01_drop_db_hics.sql 1
@call :einarbeiten1 "Create Database" 02_create_db_hics.sql 2
@call :einarbeiten2 "Create Tables" 03_create_table_hics.sql 3
@call :einarbeiten2 "Create Primary Key" 04_create_pk_hics.sql 4
@call :einarbeiten2 "Create Foreigen Key" 05_create_fk_hics.sql 5
@call :einarbeiten2 "Create Index" 06_create_index_hics.sql 6
...
cd..
@call :einarbeiten2 "Berechtigungen einarbeiten" 07_create_grant_hics_lokal.sql 1
echo. >> %log_pfad%
